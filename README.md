# Claude Code RTL - תמיכה בעברית וערבית ל-VS Code
...
3. **يضيف زر Toggle** - ينشئ زرًا (`ع`) في الواجهة لتفعيل/إيقاف وضع RTL
...
- سيظهر الزر `ع` في واجهة محادثة Claude

## كيفية الاستخدام?

1. افتح لوحة محادثة Claude Code في VS Code
2. اضغط على الزر **ع** في أعلى المحادثة
